...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['firstheading'] = 'Permission Management';
        $data['formheading'] = '';

        $permission= Permission::latest()->get();

        
        return view('setting.permission.index',['permissions'=>$permission,  'data' => $data]);
    }
    ...
    public function create()
    {
        ...
        return view('setting.permission.new',[ 'data' => $data]);
    }
    ...
    public function edit(Permission $permission)
    {
       ...
       $data['firstheading'] = 'Permission Management';
       $data['formheading'] = 'Edit Permission Information';

       $permissionsall = Permission::latest()->get();

       return view('setting.permission.new',[ 'permissionsall'=>$permissionsall,'permission'=>$permission,  'data' => $data]);
    }
