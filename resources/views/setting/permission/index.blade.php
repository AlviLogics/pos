                        ...
                        <div class="card-body">
                            ...
                            <table class="data-table data-tables-pagination responsive nowrap"
                                ...
                                @forelse($permissions as $permission)
                                    <tr>
                                        <td>
                                            <p class="list-item-heading">{{$permission->name}}</p>
                                        </td>
                                        
                                        <td>
                                        @can('Permission edit')
                                        <a href="{{route('permissions.edit',$permission->id)}}" class="text-grey-lighter font-bold py-1 px-3 rounded text-xs bg-green hover:bg-green-dark text-blue-400">Edit</a>
                                        @endcan
